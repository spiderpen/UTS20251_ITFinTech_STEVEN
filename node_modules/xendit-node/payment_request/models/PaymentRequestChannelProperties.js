...
exports.PaymentRequestChannelPropertiesToJSON = exports.PaymentRequestChannelPropertiesFromJSONTyped = exports.PaymentRequestChannelPropertiesFromJSON = exports.instanceOfPaymentRequestChannelProperties = void 0;
const runtime_1 = require("../../runtime");
/**
 * Check if a given object implements the PaymentRequestChannelProperties interface.
 */
function instanceOfPaymentRequestChannelProperties(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPaymentRequestChannelProperties = instanceOfPaymentRequestChannelProperties;
function PaymentRequestChannelPropertiesFromJSON(json) {
    return PaymentRequestChannelPropertiesFromJSONTyped(json, false);
}
exports.PaymentRequestChannelPropertiesFromJSON = PaymentRequestChannelPropertiesFromJSON;
function PaymentRequestChannelPropertiesFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'pendingReturnUrl': !(0, runtime_1.exists)(json, 'pending_return_url') ? undefined : json['pending_return_url'],
...
exports.PaymentRequestChannelPropertiesFromJSONTyped = PaymentRequestChannelPropertiesFromJSONTyped;
function PaymentRequestChannelPropertiesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PaymentRequestChannelPropertiesToJSON = PaymentRequestChannelPropertiesToJSON;
