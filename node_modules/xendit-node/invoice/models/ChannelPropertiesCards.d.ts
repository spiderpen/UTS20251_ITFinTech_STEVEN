 ...
 */
export declare function instanceOfChannelPropertiesCards(value: object): boolean;
export declare function ChannelPropertiesCardsFromJSON(json: any): ChannelPropertiesCards;
export declare function ChannelPropertiesCardsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelPropertiesCards;
